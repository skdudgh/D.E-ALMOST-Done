...
back_E_x = (screen_width / 2) - (back_E.get_width() / 2)
back_E_y = (screen_height / 1.13) - (back_E.get_height() / 2)

back_D = pygame.transform.scale(Original_back, (135, 135))
back_D_rect = back_D.get_rect()
back_D_size= back_D.get_size()
back_D_x = (screen_width / 2) - (back_D.get_width() / 2)
back_D_y = (screen_height / 1.13) - (back_D.get_height() / 2)
...
def clear():
    global background, back, back_x, back_y,Original_blue, blue, blue_x, blue_y, Original_orange, orange, orange_x, orange_y, decryption, decryption_x, decryption_y, encryption, encryption_x, encryption_y, redC, redC_x, redC_y
    original()
